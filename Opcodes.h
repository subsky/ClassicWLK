...
enum OpcodeClient : uint16
{
    ...
    CMSG_ARENA_TEAM_ACCEPT                            = 0x36B7,//0x36B6,
    CMSG_ARENA_TEAM_DECLINE                           = 0x36B8,//0x36B7,
    CMSG_ARENA_TEAM_DISBAND                           = 0x36BB,//0x36BA,
    CMSG_ARENA_TEAM_LEADER                            = 0x36BC,//0x36BB,
    CMSG_ARENA_TEAM_LEAVE                             = 0x36B9,//0x36B8,
    CMSG_ARENA_TEAM_QUERY                             = 0x36A2,
    CMSG_ARENA_TEAM_REMOVE                            = 0x36BA,//0x36B9,
    CMSG_ARENA_TEAM_ROSTER                            = 0x36B6,//0x36B5,
    CMSG_ARTIFACT_ADD_POWER                           = 0x31AC,
    CMSG_ARTIFACT_SET_APPEARANCE                      = 0x31AE,
    CMSG_ASSIGN_EQUIPMENT_SET_SPEC                    = 0x3209,
    CMSG_ATTACK_STOP                                  = 0x3255,//0x3252,
    CMSG_ATTACK_SWING                                 = 0x3254,//0x3251,
    ...
    CMSG_BATTLEMASTER_HELLO                           = 0x32AF,//0x32AA,
    ...
    CMSG_BATTLE_PAY_ACK_FAILED_RESPONSE               = 0x36D3,//0x36D2,
    CMSG_BATTLE_PAY_CANCEL_OPEN_CHECKOUT              = 0x3719,
    CMSG_BATTLE_PAY_CONFIRM_PURCHASE_RESPONSE         = 0x36D2,//0x36D1,
    ...
    CMSG_BATTLE_PAY_GET_PURCHASE_LIST                 = 0x36C3,//0x36C2,
    CMSG_BATTLE_PAY_OPEN_CHECKOUT                     = 0x3712,
    CMSG_BATTLE_PAY_REQUEST_PRICE_INFO                = 0x370E,
    CMSG_BATTLE_PAY_START_PURCHASE                    = 0x36D1,//0x36D0,
    ...
    CMSG_CANCEL_CAST                                  = 0x329D,//0x3298,
    ...
    CMSG_CHAR_DELETE                                  = 0x369C,//0x369B,
    ...
    CMSG_CHOICE_RESPONSE                              = 0x329F,//0x329A,
    ...
    CMSG_CLOSE_QUEST_CHOICE                           = 0x32A0,//0x329B,
    ...
    CMSG_DESTROY_ITEM                                 = 0x3291,//0x328C,
    ...
    CMSG_JOIN_RATED_BATTLEGROUND                      = 0x317C,//0x317B,
    ...
    CMSG_LFG_LIST_GET_STATUS                          = 0x360D,//0x360C,
    CMSG_LFG_LIST_INVITE_APPLICANT                    = 0x3611,
    CMSG_LFG_LIST_INVITE_RESPONSE                     = 0x3612,
    CMSG_LFG_LIST_LEAVE                               = 0x360B,
    CMSG_LFG_LIST_SEARCH                              = 0xBADD,//0x360D,
    CMSG_LIST_INVENTORY                               = 0x34A1,
    CMSG_LIVE_REGION_ACCOUNT_RESTORE                  = 0x36C0,//0x36BF,
    CMSG_LIVE_REGION_CHARACTER_COPY                   = 0x36BF,//0x36BE,
    CMSG_LIVE_REGION_GET_ACCOUNT_CHARACTER_LIST       = 0x36BE,//0x36BD,
    CMSG_LIVE_REGION_KEY_BINDINGS_COPY                = 0x36C1,//0x36C0,
    ...
    CMSG_LOOT_ITEM                                    = 0x3212,//0x320F,
    CMSG_LOOT_MONEY                                   = 0x3211,//0x320E,
    CMSG_LOOT_RELEASE                                 = 0x3214,//0x3211,
    CMSG_LOOT_ROLL                                    = 0x3215,//0x3212,
    CMSG_LOOT_UNIT                                    = 0x3210,//0x320D,
    ...
    CMSG_MASTER_LOOT_ITEM                             = 0x3213,//0x3210,
    ...
    CMSG_MOVE_APPLY_INERTIA_ACK                       = 0x3A4A,//0x3A4B
    CMSG_MOVE_APPLY_MOVEMENT_FORCE_ACK                = 0x3A15,//0x3A16
    CMSG_MOVE_CHANGE_TRANSPORT                        = 0x3A2F,//0x3A30
    CMSG_MOVE_CHANGE_VEHICLE_SEATS                    = 0x3A34,//0x3A35
    CMSG_MOVE_COLLISION_DISABLE_ACK                   = 0x3A39,//0x3A3A,
    CMSG_MOVE_COLLISION_ENABLE_ACK                    = 0x3A3A,//0x3A3B,
    CMSG_MOVE_DISMISS_VEHICLE                         = 0x3A33,//0x3A34
    CMSG_MOVE_DOUBLE_JUMP                             = 0x39EB,
    CMSG_MOVE_ENABLE_DOUBLE_JUMP_ACK                  = 0x3A1E,//0x3A1F,
    CMSG_MOVE_ENABLE_SWIM_TO_FLY_TRANS_ACK            = 0x3A24,//0x3A25
    CMSG_MOVE_FALL_LAND                               = 0x39FB,
    CMSG_MOVE_FALL_RESET                              = 0x3A19,//0x3A1A,
    CMSG_MOVE_FEATHER_FALL_ACK                        = 0x3A1C,//0x3A1D,
    CMSG_MOVE_FORCE_FLIGHT_BACK_SPEED_CHANGE_ACK      = 0x3A2E,//0x3A2F
    CMSG_MOVE_FORCE_FLIGHT_SPEED_CHANGE_ACK           = 0x3A2D,//0x3A2E
    CMSG_MOVE_FORCE_PITCH_RATE_CHANGE_ACK             = 0x3A32,//0x3A33
    CMSG_MOVE_FORCE_ROOT_ACK                          = 0x3A0E,//0x3A0F,
    CMSG_MOVE_FORCE_RUN_BACK_SPEED_CHANGE_ACK         = 0x3A0C,//0x3A0D,
    CMSG_MOVE_FORCE_RUN_SPEED_CHANGE_ACK              = 0x3A0B,//0x3A0C,
    CMSG_MOVE_FORCE_SWIM_BACK_SPEED_CHANGE_ACK        = 0x3A22,///0x3A23
    CMSG_MOVE_FORCE_SWIM_SPEED_CHANGE_ACK             = 0x3A0D,//0x3A0E,
    CMSG_MOVE_FORCE_TURN_RATE_CHANGE_ACK              = 0x3A23,//0x3A24
    CMSG_MOVE_FORCE_UNROOT_ACK                        = 0x3A0F,//0x3A10,
    CMSG_MOVE_FORCE_WALK_SPEED_CHANGE_ACK             = 0x3A21,//0x3A22
    CMSG_MOVE_GRAVITY_DISABLE_ACK                     = 0x3A35,//0x3A36
    CMSG_MOVE_GRAVITY_ENABLE_ACK                      = 0x3A36,//0x3A37
    CMSG_MOVE_GUILD_BANK_ITEM                         = 0x34BA,
    CMSG_MOVE_HEARTBEAT                               = 0x3A10,//0x3A11,
    CMSG_MOVE_HOVER_ACK                               = 0x3A13,//0x3A14
    CMSG_MOVE_INERTIA_DISABLE_ACK                     = 0x3A37,//0x3A38
    CMSG_MOVE_INERTIA_ENABLE_ACK                      = 0x3A38,//0x3A39
    CMSG_MOVE_INIT_ACTIVE_MOVER_COMPLETE              = 0x3A46,//0x3A47,
    CMSG_MOVE_JUMP                                    = 0x39EA,
    CMSG_MOVE_KNOCK_BACK_ACK                          = 0x3A12,//0x3A13
    CMSG_MOVE_REMOVE_INERTIA_ACK                      = 0x3A4C,
    CMSG_MOVE_REMOVE_MOVEMENT_FORCES                  = 0x3A17,//0x3A18,
    CMSG_MOVE_REMOVE_MOVEMENT_FORCE_ACK               = 0x3A16,//0x3A17
    ...
    CMSG_MOVE_SET_PITCH                               = 0x3A0A,//0x3A0B,
    CMSG_MOVE_SET_RUN_MODE                            = 0x39F2,
    CMSG_MOVE_SET_TURN_RATE_CHEAT                     = 0x3A06,
    CMSG_MOVE_SET_VEHICLE_REC_ID_ACK                  = 0x3A14,//0x3A15
    CMSG_MOVE_SET_WALK_MODE                           = 0x39F3,
    CMSG_MOVE_SPLINE_DONE                             = 0x3A18,//0x3A19
    ...
    CMSG_MOVE_TIME_SKIPPED                            = 0x3A1B,//0x3A1C
    CMSG_MOVE_UPDATE_FALL_SPEED                       = 0x3A1A,//0x3A1B
    CMSG_MOVE_WATER_WALK_ACK                          = 0x3A1D,//0x3A1E
    ...
    CMSG_PET_CAST_SPELL                               = 0x3299,//0x3294,
    ...
    CMSG_QUERY_BATTLE_PET_NAME                        = 0x3275,//0x3272,
    CMSG_QUERY_CORPSE_LOCATION_FROM_CLIENT            = 0x3661,
    CMSG_QUERY_CORPSE_TRANSPORT                       = 0x3662,
    CMSG_QUERY_COUNTDOWN_TIMER                        = 0x31AB,
    CMSG_QUERY_CREATURE                               = 0x326F,//0x326C,
    CMSG_QUERY_GAME_OBJECT                            = 0x3270,//0x326D,
    CMSG_QUERY_GARRISON_PET_NAME                      = 0x3276,//0x3273,
    CMSG_QUERY_GUILD_INFO                             = 0x368A,
    CMSG_QUERY_INSPECT_ACHIEVEMENTS                   = 0x3500,
    CMSG_QUERY_NEXT_MAIL_TIME                         = 0x3539,
    CMSG_QUERY_NPC_TEXT                               = 0x3271,//0x326E,
    CMSG_QUERY_PAGE_TEXT                              = 0x3273,//0x3270,
    CMSG_QUERY_PETITION                               = 0x3277,//0x3274
    CMSG_QUERY_PET_NAME                               = 0x3274,//0x3271,
    ...
    CMSG_QUERY_QUEST_INFO                             = 0x3272,//0x326F,
    ...
    CMSG_REPORT_CLIENT_VARIABLES                      = 0x3707,//0x3706,
    CMSG_REPORT_ENABLED_ADDONS                        = 0x3706,//0x3705,
    CMSG_REPORT_KEYBINDING_EXECUTION_COUNTS           = 0x3708,//0x3707,
    ...
    CMSG_REQUEST_CEMETERY_LIST                        = 0x317A,//0x3179,
    CMSG_REQUEST_CONQUEST_FORMULA_CONSTANTS           = 0x32B2,//0x32AD,
    CMSG_REQUEST_CROWD_CONTROL_SPELL                  = 0x352A,
    CMSG_REQUEST_FORCED_REACTIONS                     = 0x3206,//0x3207,
    CMSG_REQUEST_GUILD_PARTY_STATE                    = 0x31AA,
    CMSG_REQUEST_GUILD_REWARDS_LIST                   = 0x31A9,
    CMSG_REQUEST_LFG_LIST_BLACKLIST                   = 0x32A2,//0x329D,
    ...
    CMSG_REQUEST_PLAYED_TIME                          = 0x3279,//0x3276,
    CMSG_REQUEST_RAID_INFO                            = 0x36D0,//0x36CF,
    ...
    CMSG_SAVE_GUILD_EMBLEM                            = 0x32A6,//0x32A1,
    ...
    CMSG_SERVER_TIME_OFFSET_REQUEST                   = 0x369B,//0x369A,
    CMSG_SET_ACHIEVEMENTS_HIDDEN                      = 0x3224,
    CMSG_SET_ACTION_BAR_TOGGLES                       = 0x3532,
    CMSG_SET_ACTION_BUTTON                            = 0x3637,
    CMSG_SET_ACTIVE_MOVER                             = 0x3A3C,//0x3A3D,
    CMSG_SET_ADVANCED_COMBAT_LOGGING                  = 0x32B3,//0x32AE,
    ...
    CMSG_SET_PREFERRED_CEMETERY                       = 0x317B,//0x317A,
    CMSG_SET_PVP                                      = 0x32AA,//0x32A5,
    ...
    CMSG_SET_WAR_MODE                                 = 0x32AB,//0x32A6,
    ...
    CMSG_TABARD_VENDOR_ACTIVATE                       = 0x32A7,//0x32A2,
    ...
    CMSG_TIME_SYNC_RESPONSE                           = 0x3A3D,//0x3A3E,
    CMSG_TIME_SYNC_RESPONSE_DROPPED                   = 0x3A3F,//0x3A40,
    CMSG_TIME_SYNC_RESPONSE_FAILED                    = 0x3A3E,//0x3A3F
    CMSG_TOGGLE_DIFFICULTY                            = 0x3659,
    CMSG_TOGGLE_PVP                                   = 0x32a9,//0x32A4,
    ...
    CMSG_BATTLE_PAY_GET_PURCHASE_LIST = 0x36C2,//0x36C1,
    CMSG_BATTLE_PAY_OPEN_CHECKOUT = 0x3710,
    CMSG_BATTLE_PAY_REQUEST_PRICE_INFO = 0x370C,
    CMSG_BATTLE_PAY_START_PURCHASE = 0,//0x36CF,
    ...
    CMSG_DF_GET_JOIN_STATUS = 0x3083,//0x3614,
    ...
    CMSG_GET_UNDELETE_CHARACTER_COOLDOWN_STATUS = 0x36E4,//0x36E3,
    CMSG_GET_VAS_ACCOUNT_CHARACTER_LIST = 0x36F4,
    CMSG_GET_VAS_TRANSFER_TARGET_REALM_LIST = 0x36F5,
    CMSG_GM_TICKET_ACKNOWLEDGE_SURVEY = 0x368F,
    CMSG_GM_TICKET_GET_CASE_STATUS = 0x368E,
    ...
    CMSG_LIVE_REGION_KEY_BINDINGS_COPY = 0x36BF,
    CMSG_LOADING_SCREEN_NOTIFY = 0x35F9,
    CMSG_LOG_DISCONNECT = 0x3769,
    CMSG_LOG_STREAMING_ERROR = 0x376D,
    CMSG_LOGOUT_CANCEL = 0x34D8,
    ...
    CMSG_PING = 0x3768,
    CMSG_PLAYER_LOGIN = 0x35EB,
    CMSG_SHOWING_CLOAK = 0x3564,
    CMSG_SHOWING_HELM = 0x3563,
    CMSG_PUSH_QUEST_TO_PARTY = 0x349F,
    CMSG_PVP_LOG_DATA = 0x317F,
    ...
    CMSG_REQUEST_PVP_REWARDS = 0x3197,
    CMSG_REQUEST_RAID_INFO = 0x36cf,//0x36CE,
    CMSG_REQUEST_RATED_PVP_INFO = 0x35E4,
    ...
    CMSG_SELL_ITEM = 0x34A2,
    CMSG_SEND_CHARACTER_CLUB_INVITATION = 0x36FE,
...
{
    SMSG_ABORT_NEW_WORLD                              = 0x259E,
    SMSG_ACCOUNT_CRITERIA_UPDATE                      = 0x2869,
    SMSG_ACCOUNT_DATA_TIMES                           = 0x270C,//0x2706,
    SMSG_ACCOUNT_MOUNT_UPDATE                         = 0x25B1,//0x25AE,
    SMSG_ACCOUNT_NOTIFICATIONS_RESPONSE               = 0x2885,
    SMSG_ACCOUNT_TOY_UPDATE                           = 0x25B2,//0x25AF,
    SMSG_ACCOUNT_TRANSMOG_SET_FAVORITES_UPDATE        = 0x25B5,//0x25B2,
    SMSG_ACCOUNT_TRANSMOG_UPDATE                      = 0x25B4,//0x25B1,
    SMSG_ACHIEVEMENT_DELETED                          = 0x26EA,//0x26E5,
    SMSG_ACHIEVEMENT_EARNED                           = 0x2640,
    SMSG_ACTIVATE_ESSENCE_FAILED                      = 0x3015,
    SMSG_ACTIVATE_SOULBIND_FAILED                     = 0x3017,
    SMSG_ACTIVATE_TAXI_REPLY                          = 0x267F,//0x267A,
    SMSG_ACTIVE_GLYPHS                                = 0x2C51,//0x2C54,
    SMSG_ADDON_LIST_REQUEST                           = 0x263F,
    SMSG_ADD_BATTLENET_FRIEND_RESPONSE                = 0x213F,//0x263A,
    SMSG_ADD_ITEM_PASSIVE                             = 0x25AD,//0x25AA,
    SMSG_ADD_LOSS_OF_CONTROL                          = 0x266E,
    SMSG_ADD_RUNE_POWER                               = 0x26BA,//0x26B5,
    SMSG_ADJUST_SPLINE_DURATION                       = 0x25CE,
    SMSG_ADVENTURE_JOURNAL_DATA_RESPONSE              = 0x287A,
    SMSG_ADVENTURE_MAP_OPEN_NPC                       = 0x27F6,
    SMSG_AE_LOOT_TARGETS                              = 0x260A,//0x2615,
    SMSG_AE_LOOT_TARGET_ACK                           = 0x260B,//0x2616,
    SMSG_AI_REACTION                                  = 0x26B7,//0x26B2,
    SMSG_ALLIED_RACE_DETAILS                          = 0x27FC,
    SMSG_ALL_ACCOUNT_CRITERIA                         = 0x2571,
    SMSG_ALL_ACHIEVEMENT_DATA                         = 0x2570,
    SMSG_ALL_GUILD_ACHIEVEMENTS                       = 0x29B9,//0x29B8,
    ...
    SMSG_AREA_TRIGGER_NO_CORPSE                       = 0x2718,//0x2712,
    ...
    SMSG_ARENA_CROWD_CONTROL_SPELL_RESULT             = 0x2134,//0x262F,
    SMSG_ARENA_PREP_OPPONENT_SPECIALIZATIONS          = 0x2645,
    SMSG_ARENA_TEAM_COMMAND_RESULT                    = 0x2765,//0x275F,
    SMSG_ARENA_TEAM_EVENT                             = 0x2764,//0x275E,
    SMSG_ARENA_TEAM_INVITE                            = 0x2763,//0x275D,
    SMSG_ARENA_TEAM_ROSTER                            = 0x2762,//0x275C,
    SMSG_ARENA_TEAM_STATS                             = 0x2766,//0x2760,
    ...
    SMSG_AUCTION_CLOSED_NOTIFICATION                  = 0x26F4,//0x26EF,
    SMSG_AUCTION_COMMAND_RESULT                       = 0x26F1,//0x26EC,
    SMSG_AUCTION_FAVORITE_LIST                        = 0x2870,
    SMSG_AUCTION_HELLO_RESPONSE                       = 0x26EF,//0x26EA,
    ...
    SMSG_AUCTION_OUTBID_NOTIFICATION                  = 0x26F3,//0x26EE,
    SMSG_AUCTION_OWNER_BID_NOTIFICATION               = 0x26F5,//0x26F0,
    SMSG_AUCTION_REPLICATE_RESPONSE                   = 0x26F0,//0x26EB,
    SMSG_AUCTION_WON_NOTIFICATION                     = 0x26F2,//0x26ED,
    SMSG_AURA_POINTS_DEPLETED                         = 0x2C20,//0x2C23
    SMSG_AURA_UPDATE                                  = 0x2C1F,//0x2C22
    ...
    SMSG_BATCH_PRESENCE_SUBSCRIPTION                  = 0x284c,//0x285B,
    ...
    SMSG_BATTLENET_CHALLENGE_ABORT                    = 0x2792,//0x278C,
    SMSG_BATTLENET_CHALLENGE_START                    = 0x2791,//,//0x278B,
    SMSG_BATTLENET_NOTIFICATION                       = 0x280E,
    SMSG_BATTLENET_RESPONSE                           = 0x280D,//0x2806,
    SMSG_BATTLE_NET_CONNECTION_STATUS                 = 0x280F,
    SMSG_BATTLE_PAY_ACK_FAILED                        = 0x278A,//0x2784,
    SMSG_BATTLE_PAY_BATTLE_PET_DELIVERED              = 0x277F,//0x2779,
    SMSG_BATTLE_PAY_COLLECTION_ITEM_DELIVERED         = 0x2780,//0x277A,
    SMSG_BATTLE_PAY_CONFIRM_PURCHASE                  = 0x2789,//0x2783,
    SMSG_BATTLE_PAY_DELIVERY_ENDED                    = 0x277D,//0x2777,
    SMSG_BATTLE_PAY_DELIVERY_STARTED                  = 0x277C,//0x2776,
    SMSG_BATTLE_PAY_DISTRIBUTION_UNREVOKED            = 0x277A,//0x2774,
    SMSG_BATTLE_PAY_DISTRIBUTION_UPDATE               = 0x277B,//0x2775,
    SMSG_BATTLE_PAY_GET_DISTRIBUTION_LIST_RESPONSE    = 0x2779,//0x2773,
    SMSG_BATTLE_PAY_GET_PRODUCT_LIST_RESPONSE         = 0x2777,//0x2771,
    SMSG_BATTLE_PAY_GET_PURCHASE_LIST_RESPONSE        = 0x2778,//0x2772,
    SMSG_BATTLE_PAY_MOUNT_DELIVERED                   = 0xBADD,
    SMSG_BATTLE_PAY_PURCHASE_UPDATE                   = 0x2788,//0x2782,
    SMSG_BATTLE_PAY_START_CHECKOUT                    = 0x2823,
    SMSG_BATTLE_PAY_START_DISTRIBUTION_ASSIGN_TO_TARGET_RESPONSE = 0x2786,//0x2780,
    SMSG_BATTLE_PAY_START_PURCHASE_RESPONSE           = 0x2785,//0x277F,
    SMSG_BATTLE_PAY_VALIDATE_PURCHASE_RESPONSE        = 0x2817,
    SMSG_BATTLE_PETS_HEALED                           = 0xBADD,//0x25EF,
    SMSG_BATTLE_PET_CAGE_DATE_ERROR                   = 0x267A,//0x2675,
    SMSG_BATTLE_PET_DELETED                           = 0x25EC,
    SMSG_BATTLE_PET_ERROR                             = 0x213A,//0x2635,
    SMSG_BATTLE_PET_JOURNAL                           = 0x25F1,//0x25EB,
    SMSG_BATTLE_PET_JOURNAL_LOCK_ACQUIRED             = 0x25EF,//0x25E9,
    ...
    SMSG_BINDER_CONFIRM                               = 0x26FF,//0x26F9,
    SMSG_BIND_POINT_UPDATE                            = 0x257D,
    SMSG_BLACK_MARKET_BID_ON_ITEM_RESULT              = 0x212A,//0x2625,
    SMSG_BLACK_MARKET_OPEN_RESULT                     = 0x2128,//0x2623,
    SMSG_BLACK_MARKET_OUTBID                          = 0x212B,//0x2626,
    SMSG_BLACK_MARKET_REQUEST_ITEMS_RESULT            = 0x2129,//0x2624,
    SMSG_BLACK_MARKET_WON                             = 0x212C,//0x2627,
    ...
    SMSG_BUY_FAILED                                   = 0x26C9,//0x26C4,
    SMSG_BUY_SUCCEEDED                                = 0x26C8,//0x26C3,
    SMSG_CACHE_INFO                                   = 0x291D,
    SMSG_CACHE_VERSION                                = 0x291C,
    SMSG_CALENDAR_CLEAR_PENDING_ACTION                = 0x269F,//0x269A,
    SMSG_CALENDAR_COMMAND_RESULT                      = 0x26A0,//0x269B,
    SMSG_CALENDAR_COMMUNITY_INVITE                    = 0x268F,//0x268A,
    SMSG_CALENDAR_EVENT_REMOVED_ALERT                 = 0x2697,//0x2692,
    SMSG_CALENDAR_EVENT_UPDATED_ALERT                 = 0x2698,//0x2693,
    SMSG_CALENDAR_INVITE_ADDED                        = 0x2690,//0x268B,
    SMSG_CALENDAR_INVITE_ALERT                        = 0x2694,//0x268F,
    SMSG_CALENDAR_INVITE_NOTES                        = 0x2699,//0x2694,
    SMSG_CALENDAR_INVITE_NOTES_ALERT                  = 0x269A,//0x2695,
    SMSG_CALENDAR_INVITE_REMOVED                      = 0x2691,//0x268C,
    SMSG_CALENDAR_INVITE_REMOVED_ALERT                = 0x2696,//0x2691,
    SMSG_CALENDAR_INVITE_STATUS                       = 0x2692,//0x268D,
    SMSG_CALENDAR_INVITE_STATUS_ALERT                 = 0x2695,//0x2690,
    SMSG_CALENDAR_MODERATOR_STATUS                    = 0x2693,//0x268E,
    SMSG_CALENDAR_RAID_LOCKOUT_ADDED                  = 0x269B,//0x2696,
    SMSG_CALENDAR_RAID_LOCKOUT_REMOVED                = 0x269C,//0x2697,
    SMSG_CALENDAR_RAID_LOCKOUT_UPDATED                = 0x269D,//0x2698,
    SMSG_CALENDAR_SEND_CALENDAR                       = 0x268D,//0x2688,
    SMSG_CALENDAR_SEND_EVENT                          = 0x268E,//0x2689,
    SMSG_CALENDAR_SEND_NUM_PENDING                    = 0x269E,//0x2699,
    SMSG_CAMERA_EFFECT                                = 0x2728,//0x2722,
    SMSG_CANCEL_AUTO_REPEAT                           = 0x26E0,//0x26DB,
    SMSG_CANCEL_COMBAT                                = 0x294B,//x294A,
    SMSG_CANCEL_ORPHAN_SPELL_VISUAL                   = 0x2C43,//0x2C46,
    SMSG_CANCEL_SCENE                                 = 0x2139,//0x2634,
    SMSG_CANCEL_SPELL_VISUAL                          = 0x2C41,//0x2C44,
    SMSG_CANCEL_SPELL_VISUAL_KIT                      = 0x2C45,//0x2C48,
    SMSG_CAN_DUEL_RESULT                              = 0x2946,
    SMSG_CAN_REDEEM_TOKEN_FOR_BALANCE_RESPONSE        = 0x2816,
    SMSG_CAPTURE_POINT_REMOVED                        = 0x292A,
    SMSG_CAST_FAILED                                  = 0x2C54,//0x2C57,
    //SMSG_CATEGORY_COOLDOWN                            = 0x2C16,
    SMSG_CHAIN_MISSILE_BOUNCE                         = 0xBADD,//0x25C6,
    ...
    SMSG_CHARACTER_LOGIN_FAILED                       = 0x2707,//0x2701,
    SMSG_CHARACTER_OBJECT_TEST_RESPONSE               = 0x2790,//0x278A,
    SMSG_CHARACTER_RENAME_RESULT                      = 0x2769,//0x2763,
    ...
    SMSG_CHAR_CUSTOMIZE_FAILURE                       = 0x26E4,//0x26DF,
    SMSG_CHAR_CUSTOMIZE_SUCCESS                       = 0x26E5,//0x26E0,
    ...
    SMSG_CLEAR_ALL_SPELL_CHARGES                      = 0x2C24,//0x2C27
    SMSG_CLEAR_BOSS_EMOTES                            = 0x25BD,//0x25B9,
    SMSG_CLEAR_COOLDOWN                               = 0x26BC,//0x26B7,
    SMSG_CLEAR_COOLDOWNS                              = 0x2C23,//0x2C26,
    SMSG_CLEAR_RESURRECT                              = 0x257F,
    SMSG_CLEAR_SPELL_CHARGES                          = 0x2C25,//0x2C28
    SMSG_CLEAR_TARGET                                 = 0x2947,
    SMSG_CLEAR_TREASURE_PICKER_CACHE                  = 0x2AA1,
    SMSG_CLOSE_HEART_FORGE                            = 0xBADD,//0x2829,
    SMSG_COIN_REMOVED                                 = 0x2619,//0x2614,
    SMSG_COMBAT_EVENT_FAILED                          = 0x293E,
    SMSG_COMMENTATOR_MAP_INFO                         = 0x2709,//0x2703,
    SMSG_COMMENTATOR_PLAYER_INFO                      = 0x270A,//0x2704,
    SMSG_COMMENTATOR_STATE_CHANGED                    = 0x2708,//0x2702,
    ...
    SMSG_COMMERCE_TOKEN_UPDATE                        = 0xBADD,
    SMSG_COMPLAINT_RESULT                             = 0x26AD,//0x26A8,
    SMSG_COMPLETE_SHIPMENT_RESPONSE                   = 0x279D,
    SMSG_CONFIRM_PARTY_INVITE                         = 0x2815,
    SMSG_CONNECT_TO                                   = 0x304D,
    SMSG_CONQUEST_FORMULA_CONSTANTS                   = 0x278B,//0x2785,
    SMSG_CONSOLE_WRITE                                = 0x2137,//0x2632,
    ...
    SMSG_CONTACT_LIST                                 = 0x278E,//0x2788,
    SMSG_CONTRIBUTION_LAST_UPDATE_RESPONSE            = 0x281C,
    SMSG_CONTROL_UPDATE                               = 0x2644,
    SMSG_CONVERT_ITEMS_TO_CURRENCY_VALUE              = 0x287D,
    SMSG_COOLDOWN_CHEAT                               = 0xBADD,//0x2735,
    SMSG_COOLDOWN_EVENT                               = 0x26BB,//0x26B6,
    SMSG_CORPSE_LOCATION                              = 0x2651,//0x264C,
    SMSG_CORPSE_RECLAIM_DELAY                         = 0x274C,//0x2746,
    SMSG_CORPSE_TRANSPORT_QUERY                       = 0x2714,//0x270E,
    ...
    SMSG_CREATE_CHAR                                  = 0x2703,//0x26FD,
    SMSG_CREATE_SHIPMENT_RESPONSE                     = 0x279C,
    SMSG_CRITERIA_DELETED                             = 0x26E9,//0x26E4,
    SMSG_CRITERIA_UPDATE                              = 0x26E3,//0x26DE,
    SMSG_CROSSED_INEBRIATION_THRESHOLD                = 0x26C4,//0x26BF,
    SMSG_CUSTOM_LOAD_SCREEN                           = 0x25C9,
    SMSG_DAILY_QUESTS_RESET                           = 0x2A80,
    SMSG_DAMAGE_CALC_LOG                              = 0x27C8,
    SMSG_DB_REPLY                                     = 0x290E,
    SMSG_DEATH_RELEASE_LOC                            = 0x26D5,//0x26D0,
    SMSG_DEBUG_MENU_MANAGER_FULL_UPDATE               = 0x2652,
    SMSG_DEFENSE_MESSAGE                              = 0x2BB6,
    SMSG_DELETE_CHAR                                  = 0x2704,//x26FE,
    SMSG_DESTROY_ARENA_UNIT                           = 0x2743,//0x273E,--
    SMSG_DESTRUCTIBLE_BUILDING_DAMAGE                 = 0x26FB,//0x26F5,
    SMSG_DIFFERENT_INSTANCE_FROM_PARTY                = 0x258D,
    SMSG_DISENCHANT_CREDIT                            = 0x25A7,
    SMSG_DISMOUNT                                     = 0x26B3,//0x26AE,
    SMSG_DISMOUNT_RESULT                              = 0x257C,
    SMSG_DISPEL_FAILED                                = 0x2C2D,//0x2C30
    SMSG_DISPLAY_GAME_ERROR                           = 0x25A3,
    SMSG_DISPLAY_PLAYER_CHOICE                        = 0x2FFC,
    SMSG_DISPLAY_PROMOTION                            = 0x264E,//0x2649,
    SMSG_DISPLAY_QUEST_POPUP                          = 0x2A9E,
    SMSG_DISPLAY_TOAST                                = 0x2126,//0x2621,
    ...
    SMSG_DURABILITY_DAMAGE_DEATH                      = 0x2747,//0x2742,--
    SMSG_EMOTE                                        = 0x27C9,
    SMSG_ENCHANTMENT_LOG                              = 0x2715,//0x270F,
    SMSG_ENCOUNTER_END                                = 0x2784,//0x277E,
    SMSG_ENCOUNTER_START                              = 0x2783,//0x277D,
    SMSG_END_LIGHTNING_STORM                          = 0x26AA,//0x26A5
    SMSG_ENTER_ENCRYPTED_MODE                         = 0x3049,
    SMSG_ENUM_CHARACTERS_RESULT                       = 0x2583,
    SMSG_ENUM_VAS_PURCHASE_STATES_RESPONSE            = 0x27FB,//0x27F5,
    SMSG_ENVIRONMENTAL_DAMAGE_LOG                     = 0x2C1E,//0x2C21,
    SMSG_EQUIPMENT_SET_ID                             = 0x26B4,//0x26AF,
    SMSG_EXPECTED_SPAM_RECORDS                        = 0x2BB1,
    SMSG_EXPLORATION_EXPERIENCE                       = 0x2761,//0x275B,
    SMSG_EXTERNAL_TRANSACTION_ID_GENERATED            = 0x287B,
    SMSG_FACTION_BONUS_INFO                           = 0x2727,//0x2721,
    SMSG_FAILED_PLAYER_CONDITION                      = 0x2FFA,
    SMSG_FAILED_QUEST_TURN_IN                         = 0x2812,
    SMSG_FEATURE_SYSTEM_STATUS                        = 0x25C1,//0x25BD,
    SMSG_FEATURE_SYSTEM_STATUS_GLUE_SCREEN            = 0x25C2,//0x25BE,
    SMSG_FEIGN_DEATH_RESISTED                         = 0x2746,//0x2741,--
    SMSG_FISH_ESCAPED                                 = 0x26D2,//0x26CD,
    SMSG_FISH_NOT_HOOKED                              = 0x26D1,//0x26CC,
    SMSG_FLIGHT_SPLINE_SYNC                           = 0x2E2B,
    SMSG_FORCED_DEATH_UPDATE                          = 0x26D6,//0x26D1,
    SMSG_FORCE_ANIM                                   = 0x2753,//0x274D,
    SMSG_FORCE_ANIMATIONS                             = 0x2754,//0x274E,
    SMSG_FORCE_OBJECT_RELINK                          = 0x2648,
    SMSG_FRIEND_STATUS                                = 0x278F,//0x2789,
    SMSG_GAME_OBJECT_ACTIVATE_ANIM_KIT                = 0x25C5,//0x25C1,
    SMSG_GAME_OBJECT_BASE                             = 0x282A,
    SMSG_GAME_OBJECT_CUSTOM_ANIM                      = 0x25C6,//0x25C2,
    SMSG_GAME_OBJECT_DESPAWN                          = 0x25C7,//0x25C3,
    SMSG_GAME_OBJECT_PLAY_SPELL_VISUAL                = 0x2C48,//0x2C4B,
    SMSG_GAME_OBJECT_PLAY_SPELL_VISUAL_KIT            = 0x2C47,//0x2C4A,
    SMSG_GAME_OBJECT_RESET_STATE                      = 0x2720,//0x271A,
    SMSG_GAME_OBJECT_SET_STATE_LOCAL                  = 0x2805,
    SMSG_GAME_OBJECT_UI_LINK                          = 0x271C,//0x2716,
    SMSG_GAME_SPEED_SET                               = 0x2683,//0x267E,
    SMSG_GAME_TIME_SET                                = 0x270E,//0x2708,
    SMSG_GAME_TIME_UPDATE                             = 0x270D,//0x2707,
    SMSG_GENERATE_RANDOM_CHARACTER_NAME_RESULT        = 0x2585,
    SMSG_GENERATE_SSO_TOKEN_RESPONSE                  = 0x281D,
    SMSG_GET_ACCOUNT_CHARACTER_LIST_RESULT            = 0x2767,//0x2761,
    ...
    SMSG_GM_TICKET_CASE_STATUS                        = 0x26A5,//0x26A0,
    SMSG_GM_TICKET_SYSTEM_STATUS                      = 0x26A4,//0x269F,
    SMSG_GOD_MODE                                     = 0x26FC,//0x26F8,
    ...
    SMSG_GROUP_NEW_LEADER                             = 0x212F,//0x262A,
    SMSG_GROUP_UNINVITE                               = 0x2792,
    SMSG_GUILD_ACHIEVEMENT_DELETED                    = 0x29C6,//0x29C5,
    SMSG_GUILD_ACHIEVEMENT_EARNED                     = 0x29C5,//0x29C4,
    SMSG_GUILD_ACHIEVEMENT_MEMBERS                    = 0x29C8,//0x29C7,
    SMSG_GUILD_BANK_LOG_QUERY_RESULTS                 = 0x29E0,//0x29DF,
    SMSG_GUILD_BANK_QUERY_RESULTS                     = 0x29DF,//0x29DE,
    SMSG_GUILD_BANK_REMAINING_WITHDRAW_MONEY          = 0x29E1,//0x29E0,
    SMSG_GUILD_BANK_TEXT_QUERY_RESULT                 = 0x29E4,//0x29E3,
    SMSG_GUILD_CHALLENGE_COMPLETED                    = 0x29D4,//0x29D3,
    SMSG_GUILD_CHALLENGE_UPDATE                       = 0x29D3,//0x29D2,
    SMSG_GUILD_CHANGE_NAME_RESULT                     = 0x29DE,//0x29DD,
    SMSG_GUILD_COMMAND_RESULT                         = 0x29BB,//0x29BA,
    SMSG_GUILD_CRITERIA_DELETED                       = 0x29C7,//0x29C6,
    SMSG_GUILD_CRITERIA_UPDATE                        = 0x29C4,//0x29C3,
    SMSG_GUILD_EVENT_BANK_CONTENTS_CHANGED            = 0x29F8,//0x29F7,
    SMSG_GUILD_EVENT_BANK_MONEY_CHANGED               = 0x29F7,//0x29F6,
    SMSG_GUILD_EVENT_DISBANDED                        = 0x29EE,//0x29ED,
    SMSG_GUILD_EVENT_LOG_QUERY_RESULTS                = 0x29E3,//0x29E2,
    SMSG_GUILD_EVENT_MOTD                             = 0x29EF,//0x29EE,
    SMSG_GUILD_EVENT_NEW_LEADER                       = 0x29ED,//0x29EC,
    SMSG_GUILD_EVENT_PLAYER_JOINED                    = 0x29EB,//0x29EA,
    SMSG_GUILD_EVENT_PLAYER_LEFT                      = 0x29EC,//0x29EB,
    SMSG_GUILD_EVENT_PRESENCE_CHANGE                  = 0x29F0,//0x29EF,
    SMSG_GUILD_EVENT_RANKS_UPDATED                    = 0x29F1,//0x29F0,
    SMSG_GUILD_EVENT_RANK_CHANGED                     = 0x29F2,//0x29F1,
    SMSG_GUILD_EVENT_TAB_ADDED                        = 0x29F3,//0x29F2,
    SMSG_GUILD_EVENT_TAB_DELETED                      = 0x29F4,//0x29F3,
    SMSG_GUILD_EVENT_TAB_MODIFIED                     = 0x29F5,//0x29F4,
    SMSG_GUILD_EVENT_TAB_TEXT_CHANGED                 = 0x29F6,//0x29F5,
    SMSG_GUILD_FLAGGED_FOR_RENAME                     = 0x29DD,//0x29DC,
    SMSG_GUILD_INVITE                                 = 0x29CB,//0x29CA,
    SMSG_GUILD_INVITE_DECLINED                        = 0x29E9,//0x29E8,
    SMSG_GUILD_INVITE_EXPIRED                         = 0x29EA,//0x29E9,
    SMSG_GUILD_ITEM_LOOTED_NOTIFY                     = 0x29D5,//0x29D4,
    SMSG_GUILD_KNOWN_RECIPES                          = 0x29BF,//0x29BE,
    SMSG_GUILD_MEMBERS_WITH_RECIPE                    = 0x29C0,//0x29BF,
    SMSG_GUILD_MEMBER_DAILY_RESET                     = 0x29E5,//0x29E4,
    SMSG_GUILD_MEMBER_RECIPES                         = 0x29BE,//0x29BD,
    SMSG_GUILD_MEMBER_UPDATE_NOTE                     = 0x29CA,//0x29C9,
    SMSG_GUILD_MOVED                                  = 0x29DB,//0x29DA,
    SMSG_GUILD_MOVE_STARTING                          = 0x29DA,//0x29D9,
    SMSG_GUILD_NAME_CHANGED                           = 0x29DC,//0x29DB,
    SMSG_GUILD_NEWS                                   = 0x29C2,//0x29C1,
    SMSG_GUILD_NEWS_DELETED                           = 0x29C3,//0x29C2,
    SMSG_GUILD_PARTY_STATE                            = 0x29CC,//0x29CB,
    SMSG_GUILD_PERMISSIONS_QUERY_RESULTS              = 0x29E2,//0x29E1,
    SMSG_GUILD_RANKS                                  = 0x29C9,//0x29C8,
    SMSG_GUILD_REPUTATION_REACTION_CHANGED            = 0x29CD,//0x29CC,
    SMSG_GUILD_RESET                                  = 0x29D9,//0x29D8,
    SMSG_GUILD_REWARD_LIST                            = 0x29C1,//0x29C0,
    SMSG_GUILD_ROSTER                                 = 0x29BC,//0x29BB,
    SMSG_GUILD_ROSTER_UPDATE                          = 0x29BD,//0x29BC,
    SMSG_GUILD_SEND_RANK_CHANGE                       = 0x29BA,//0x29B9,

    SMSG_HEALTH_UPDATE                                = 0x26D3,//0x26CE,
    SMSG_HIGHEST_THREAT_UPDATE                        = 0x26DB,//0x26D6,
    SMSG_HOTFIX_CONNECT                               = 0x2911,
    SMSG_HOTFIX_MESSAGE                               = 0x2910,
    SMSG_INITIALIZE_FACTIONS                          = 0x2726,//0x2720,
    SMSG_INITIAL_SETUP                                = 0x2580,
    SMSG_INIT_WORLD_STATES                            = 0x2748,//0x2743,
    SMSG_INSPECT_HONOR_STATS                          = 0x2933,
    SMSG_INSPECT_PVP                                  = 0x2724,//0x271E,
    SMSG_INSPECT_RESULT                               = 0x2633,//0x262E,
    ...
    SMSG_INSTANCE_GROUP_SIZE_CHANGED                  = 0x26FC,//0x26F6,
    SMSG_INSTANCE_INFO                                = 0x2636,//0x2631,
    SMSG_INSTANCE_RESET                               = 0x2688,//0x2683,
    SMSG_INSTANCE_RESET_FAILED                        = 0x2689,//0x2684,
    SMSG_INSTANCE_SAVE_CREATED                        = 0x2782,//0x277C,
    SMSG_INTERRUPT_POWER_REGEN                        = 0x2C56,//0x2C59,
    SMSG_INVALIDATE_PAGE_TEXT                         = 0x2918,
    SMSG_INVALIDATE_PLAYER                            = 0x2FFF,
    SMSG_INVALID_PROMOTION_CODE                       = 0x2755,//0x274F,
    SMSG_INVENTORY_CHANGE_FAILURE                     = 0x2DA5,
    SMSG_INVENTORY_FIXUP_COMPLETE                     = 0x2814,
    SMSG_INVENTORY_FULL_OVERFLOW                      = 0x2825,
    SMSG_ISLANDS_MISSION_NPC                          = 0xBADD,//0x27FB,
    SMSG_ISLAND_AZERITE_GAIN                          = 0x275E,//0x2758,
    SMSG_ISLAND_COMPLETE                              = 0x275F,//0x2759,
    SMSG_IS_QUEST_COMPLETE_RESPONSE                   = 0x2A84,
    SMSG_ITEM_CHANGED                                 = 0x26EC,//0x26E7,
    SMSG_ITEM_COOLDOWN                                = 0x27C7,
    SMSG_ITEM_ENCHANT_TIME_UPDATE                     = 0x2757,//0x2751,
    SMSG_ITEM_EXPIRE_PURCHASE_REFUND                  = 0x25A2,
    SMSG_ITEM_INTERACTION_COMPLETE                    = 0x2873,
    SMSG_ITEM_PURCHASE_REFUND_RESULT                  = 0x25A0,
    SMSG_ITEM_PUSH_RESULT                             = 0x2625,//0x2620,
    SMSG_ITEM_TIME_UPDATE                             = 0x2756,//0x2750,
    SMSG_KICK_REASON                                  = 0x268B,//0x2686,
    SMSG_LATENCY_REPORT_PING                          = 0x2886,
    SMSG_LEARNED_SPELLS                               = 0x2C4A,//0x2C4D,
    SMSG_LEARN_PVP_TALENT_FAILED                      = 0x25D0,
    SMSG_LEARN_TALENT_FAILED                          = 0x25CF,
    SMSG_LEGACY_LOOT_RULES                            = 0x2831,//0x282B,
    SMSG_LEVEL_UP_INFO                                = 0x26EB,//0x26E6,
    ...
    SMSG_LFG_LIST_UPDATE_BLACKLIST                    = 0xBADD,//0x2A2A,
    ...
    SMSG_LFG_PLAYER_INFO                              = 0x2A2A,//0x2A37,
    ...
    SMSG_LIVE_REGION_ACCOUNT_RESTORE_RESULT           = 0x2774,//0x276E,
    SMSG_LIVE_REGION_CHARACTER_COPY_RESULT            = 0x2773,//0x276D,
    SMSG_LIVE_REGION_GET_ACCOUNT_CHARACTER_LIST_RESULT = 0x2768,//0x2762,
    SMSG_LIVE_REGION_KEY_BINDINGS_COPY_RESULT         = 0x2775,//0x276F,
    SMSG_LOAD_CUF_PROFILES                            = 0x25BE,//0x25BA,
    SMSG_LOAD_EQUIPMENT_SET                           = 0x2710,//0x270A,
    SMSG_LOGIN_SET_TIME_SPEED                         = 0x270F,//0x2709,
    SMSG_LOGIN_VERIFY_WORLD                           = 0x259D,
    SMSG_LOGOUT_CANCEL_ACK                            = 0x2687,//0x2682,
    SMSG_LOGOUT_COMPLETE                              = 0x2686,//0x2681,
    SMSG_LOGOUT_RESPONSE                              = 0x2685,//0x2680,
    SMSG_LOG_XP_GAIN                                  = 0x26E7,//0x26E2,
    SMSG_LOOT_ALL_PASSED                              = 0x2123,//0x261E,
    SMSG_LOOT_LIST                                    = 0x2742,//0x273D,--
    SMSG_LOOT_MONEY_NOTIFY                            = 0x261E,//0x2619,
    SMSG_LOOT_RELEASE                                 = 0x261D,//0x2618,
    SMSG_LOOT_RELEASE_ALL                             = 0x261C,//0x2617,
    SMSG_LOOT_REMOVED                                 = 0x2617,//0x2612,
    SMSG_LOOT_RESPONSE                                = 0x2616,//0x2611,
    SMSG_LOOT_ROLL                                    = 0x2620,//0x261B,
    SMSG_LOOT_ROLLS_COMPLETE                          = 0x2622,//0x261D,
    SMSG_LOOT_ROLL_WON                                = 0x2124,//0x261F,
    SMSG_LOSS_OF_CONTROL_AURA_UPDATE                  = 0x266D,
    SMSG_MAIL_COMMAND_RESULT                          = 0x213D,//0x2638,
    SMSG_MAIL_LIST_RESULT                             = 0x2758,//0x2752,
    SMSG_MAIL_QUERY_NEXT_TIME_RESULT                  = 0x2759,//0x2753,
    SMSG_MAP_OBJECTIVES_INIT                          = 0x294F,
    SMSG_MAP_OBJ_EVENTS                               = 0x25C8,//0x25C4,
    SMSG_MASTER_LOOT_CANDIDATE_LIST                   = 0x2621,//0x261C,
    SMSG_MESSAGE_BOX                                  = 0x2576,
    SMSG_MINIMAP_PING                                 = 0x26D0,//0x26CB,
    SMSG_MIRROR_IMAGE_COMPONENTED_DATA                = 0x2C14,
    SMSG_MIRROR_IMAGE_CREATURE_DATA                   = 0x2C13,
    SMSG_MISSILE_CANCEL                               = 0xBADD,//0x25C5,
    SMSG_MODIFY_COOLDOWN                              = 0x276A,//0x2764,
    SMSG_MOTD                                         = 0x2BAF,
    ...
    SMSG_NEW_TAXI_PATH                                = 0x2680,//0x267B,
    SMSG_NEW_WORLD                                    = 0x259A,
    SMSG_NOTIFY_DEST_LOC_SPELL_CAST                   = 0x2C40,//0x2C43,
    SMSG_NOTIFY_MISSILE_TRAJECTORY_COLLISION          = 0x26AC,//0x26A7,
    SMSG_NOTIFY_MONEY                                 = 0x259F,
    SMSG_NOTIFY_RECEIVED_MAIL                         = 0x213E,//0x2639,
    SMSG_OFFER_PETITION_ERROR                         = 0x26B8,//0x26B3,
    SMSG_ON_CANCEL_EXPECTED_RIDE_VEHICLE_AURA         = 0x26E8,//0x26E3,
    SMSG_ON_MONSTER_MOVE                              = 0x2DD4,
    SMSG_OPEN_ANIMA_DIVERSION_UI                      = 0x271D,//0x2717,
    SMSG_OPEN_CONTAINER                               = 0x2DA6,
    SMSG_OPEN_HEART_FORGE                             = 0xBADD,//0x2828,
    SMSG_OPEN_LFG_DUNGEON_FINDER                      = 0x2A31,
    SMSG_OPEN_SHIPMENT_NPC_FROM_GOSSIP                = 0x2799,
    SMSG_OPEN_SHIPMENT_NPC_RESULT                     = 0x279B,
    SMSG_OVERRIDE_LIGHT                               = 0x26BD,//0x26B8,
    SMSG_PAGE_TEXT                                    = 0x271B,//0x2715,
    SMSG_PARTY_COMMAND_RESULT                         = 0x2795,
    SMSG_PARTY_INVITE                                 = 0x25BF,//0x25BB,
    SMSG_PARTY_KILL_LOG                               = 0x275C,//0x2756,
    SMSG_PARTY_MEMBER_FULL_STATE                      = 0x275B,//0x2755,
    SMSG_PARTY_MEMBER_PARTIAL_STATE                   = 0x275A,//0x2754,
    SMSG_PARTY_NOTIFY_LFG_LEADER_CHANGE               = 0x2879,
    SMSG_PARTY_UPDATE                                 = 0xBADD,//0x25F1,
    SMSG_PAST_TIME_EVENTS                             = 0x25C4,//0x25C0,
    SMSG_PAUSE_MIRROR_TIMER                           = 0x2712,//0x270C,
    SMSG_PENDING_RAID_LOCK                            = 0x26FA,//0x26F4,
    SMSG_PETITION_ALREADY_SIGNED                      = 0x25A3,
    SMSG_PETITION_RENAME_GUILD_RESPONSE               = 0x29F9,
    SMSG_PETITION_SHOW_LIST                           = 0x26C1,//0x26BC,
    SMSG_PETITION_SHOW_SIGNATURES                     = 0x26C2,//0x26BD,
    SMSG_PETITION_SIGN_RESULTS                        = 0x274E,//0x2748,
    SMSG_PET_ACTION_FEEDBACK                          = 0x274A,//0x2745,--
    SMSG_PET_ACTION_SOUND                             = 0x26A2,//0x269D,
    SMSG_PET_ADDED                                    = 0x2597,
    SMSG_PET_BATTLE_CHAT_RESTRICTED                   = 0x25FF,
    SMSG_PET_BATTLE_DEBUG_QUEUE_DUMP_RESPONSE         = 0x2677,//0x2672,
    ...
    SMSG_PET_BATTLE_QUEUE_PROPOSE_MATCH               = 0x213B,//0x2636,
    SMSG_PET_BATTLE_QUEUE_STATUS                      = 0x213C,//0x2637,
    ...
    SMSG_PET_CAST_FAILED                              = 0x2C55,//0x2C58,
    SMSG_PET_CLEAR_SPELLS                             = 0x2C21,//0x2C24
    SMSG_PET_DISMISS_SOUND                            = 0x26A3,//0x269E,
    SMSG_PET_GOD_MODE                                 = 0x267D,//0x2678,
    SMSG_PET_GUIDS                                    = 0x2706,//0x2700,
    SMSG_PET_LEARNED_SPELLS                           = 0x2C4C,//0x2C4F,
    SMSG_PET_MODE                                     = 0x258C,
    SMSG_PET_NAME_INVALID                             = 0x26C6,//0x26C1,
    SMSG_PET_NEWLY_TAMED                              = 0x2589,
    SMSG_PET_SLOT_UPDATED                             = 0x258B,
    SMSG_PET_SPELLS_MESSAGE                           = 0x2C22,//0x2C25
    SMSG_PET_STABLE_LIST                              = 0x2598,
    SMSG_PET_STABLE_RESULT                            = 0x2599,
    SMSG_PET_TAME_FAILURE                             = 0x26B5,//0x26B0,
    SMSG_PET_UNLEARNED_SPELLS                         = 0x2C4D,//0x2C50,
    SMSG_PHASE_SHIFT_CHANGE                           = 0x2578,
    SMSG_PLAYED_TIME                                  = 0x26D7,//0x26D2,
    ...
    SMSG_PLAY_MUSIC                                   = 0x276F,//0x2769,
    SMSG_PLAY_OBJECT_SOUND                            = 0x2770,//0x276A,
    SMSG_PLAY_ONE_SHOT_ANIM_KIT                       = 0x2733,//0x272D,
    SMSG_PLAY_ORPHAN_SPELL_VISUAL                     = 0x2C44,//0x2C47,
    SMSG_PLAY_SCENE                                   = 0x2138,//0x2633,
    SMSG_PLAY_SOUND                                   = 0x276E,//0x2768,
    SMSG_PLAY_SPEAKERBOT_SOUND                        = 0x2771,//0x276B,
    SMSG_PLAY_SPELL_VISUAL                            = 0x2C42,//0x2C45,
    SMSG_PLAY_SPELL_VISUAL_KIT                        = 0x2C46,//0x2C49,
    SMSG_PLAY_TIME_WARNING                            = 0x2700,//0x26FA,
    SMSG_PONG                                         = 0x304E,
    SMSG_POWER_UPDATE                                 = 0x26D4,//0x26CF,
    SMSG_PRELOAD_CHILD_MAP                            = 0x2579,
    SMSG_PREPOPULATE_NAME_CACHE                       = 0x285F,
    SMSG_PRE_RESSURECT                                = 0x276D,//0x2767,
    SMSG_PRINT_NOTIFICATION                           = 0xBADD,//0x25C8,
    SMSG_PROC_RESIST                                  = 0x275D,//0x2757,
    SMSG_PUSH_SPELL_TO_ACTION_BAR                     = 0x2C4E,//0x2C51,
    ...
    SMSG_QUERY_GUILD_INFO_RESPONSE                    = 0x29E6,//0x29E5,
    ...
    SMSG_QUERY_REALM_GUILD_MASTER_INFO_RESPONSE       = 0xBADD,//0x29E6,
    SMSG_QUERY_TIME_RESPONSE                          = 0x26E6,//0x26E1,
    ...
    SMSG_RANDOM_ROLL                                  = 0x2132,//0x262D,
    ...
    SMSG_REALM_LOOKUP_INFO                            = 0x27D2,//0x27CC,
    SMSG_REALM_QUERY_RESPONSE                         = 0x2913,
    SMSG_REATTACH_RESURRECT                           = 0x274D,//0x2747,
    SMSG_RECRUIT_A_FRIEND_FAILURE                     = 0x26C3,//0x26BE,
    SMSG_REFRESH_COMPONENT                            = 0xBADD,//0x264E,
    SMSG_REFRESH_SPELL_HISTORY                        = 0x2C29,
    SMSG_REMOVE_ITEM_PASSIVE                          = 0x25AE,//0x25AB,
    SMSG_REMOVE_SPELL_FROM_ACTION_BAR                 = 0x2C4F,//0x2C52,
    ...
    SMSG_RESET_FAILED_NOTIFY                          = 0x26B9,//0x26B4,
    ...
    SMSG_RESTRICTED_ACCOUNT_WARNING                   = 0x25BB,//0x25B7,
    SMSG_RESUME_CAST                                  = 0x2C38,//0x2C3B,
    SMSG_RESUME_CAST_BAR                              = 0x2C3B,//0x2C3E,
    SMSG_RESUME_COMMS                                 = 0x304B,
    SMSG_RESUME_TOKEN                                 = 0x25AC,//0x25A9,
    ...
    SMSG_RUNE_REGEN_DEBUG                             = 0x25B8,//0x25B4,
    SMSG_SCENARIO_COMPLETED                           = 0x27EE,
    SMSG_SCENARIO_POIS                                = 0x2135,//0x2630,
    SMSG_SCENARIO_PROGRESS_UPDATE                     = 0x212E,//0x2629,
    SMSG_SCENARIO_SHOW_CRITERIA                       = 0x2803,
    SMSG_SCENARIO_STATE                               = 0x212D,//0x2628,
    ...
    SMSG_SCENE_OBJECT_PET_BATTLE_REPLACEMENTS_MADE    = 0xBADD,//0x25E2,
    SMSG_SCENE_OBJECT_PET_BATTLE_ROUND_RESULT         = 0x25E1,
    SMSG_SCRIPT_CAST                                  = 0x2C53,//0x2C56,
    SMSG_SEASON_INFO                                  = 0x25C3,//0x25BF,
    SMSG_SELL_RESPONSE                                = 0x26C7,//0x26C2,
    SMSG_SEND_ITEM_PASSIVES                           = 0x25AF,//0x25AC,
    SMSG_SEND_KNOWN_SPELLS                            = 0x2C27,//0x2C2A
    SMSG_SEND_RAID_TARGET_UPDATE_ALL                  = 0x2130,//0x262B,
    SMSG_SEND_RAID_TARGET_UPDATE_SINGLE               = 0x2131,//0x262C,
    SMSG_SEND_SPELL_CHARGES                           = 0x2C2A,
    SMSG_SEND_SPELL_HISTORY                           = 0x2C28,//0x262B
    SMSG_SEND_UNLEARN_SPELLS                          = 0x2C2B,
    SMSG_SERVER_FIRST_ACHIEVEMENTS                    = 0x264B,
    SMSG_SERVER_TIME                                  = 0x2684,//0x267F,
    SMSG_SERVER_TIME_OFFSET                           = 0x2716,//0x2710,
    SMSG_SETUP_CURRENCY                               = 0x2573,
    SMSG_SETUP_RESEARCH_HISTORY                       = 0x2586,
    SMSG_SET_AI_ANIM_KIT                              = 0x2732,//0x272C,
    SMSG_SET_ALL_TASK_PROGRESS                        = 0x2794,//0x278E,
    SMSG_SET_ANIM_TIER                                = 0x2736,//0x2730,
    SMSG_SET_CHR_UPGRADE_TIER                         = 0x25DB,
    SMSG_SET_CURRENCY                                 = 0x2574,
    SMSG_SET_DF_FAST_LAUNCH_RESULT                    = 0x2A2E,
    SMSG_SET_DUNGEON_DIFFICULTY                       = 0x26A6,//0x26A1,
    SMSG_SET_FACTION_AT_WAR                           = 0x2702,//0x26FC,
    SMSG_SET_FACTION_NOT_VISIBLE                      = 0x272D,//0x2727,
    SMSG_SET_FACTION_STANDING                         = 0x272E,//0x2728,
    SMSG_SET_FACTION_VISIBLE                          = 0x272C,//0x2726,
    SMSG_SET_FLAT_SPELL_MODIFIER                      = 0x2C33,//0x2C36,
    SMSG_SET_FORCED_REACTIONS                         = 0x271F,//0x2719,
    SMSG_SET_ITEM_PURCHASE_DATA                       = 0x25A1,
    SMSG_SET_LOOT_METHOD_FAILED                       = 0xBADD,//0x27D2,
    SMSG_SET_MAX_WEEKLY_QUANTITY                      = 0x25A4,
    SMSG_SET_MELEE_ANIM_KIT                           = 0x2735,//0x272F,
    SMSG_SET_MOVEMENT_ANIM_KIT                        = 0x2734,//0x272E,
    SMSG_SET_PCT_SPELL_MODIFIER                       = 0x2C34,//0x2C37,
    SMSG_SET_PET_SPECIALIZATION                       = 0x2627,//0x2622,
    SMSG_SET_PLAYER_DECLINED_NAMES_RESULT             = 0x3003,
    SMSG_SET_PLAY_HOVER_ANIM                          = 0x25BC,//0x25B8,
    SMSG_SET_PROFICIENCY                              = 0x2737,//0x2731,
    SMSG_SET_SPELL_CHARGES                            = 0x2C26,//0x2C29
    SMSG_SET_TASK_COMPLETE                            = 0x278F,
    SMSG_SET_TIME_ZONE_INFORMATION                    = 0x2679,//0x2674,
    SMSG_SET_VEHICLE_REC_ID                           = 0x26F9,//0x26F3,
    SMSG_SHOW_BANK                                    = 0x2681,//0x267C,
    SMSG_SHOW_MAILBOX                                 = 0x27AA,
    SMSG_SHOW_NEUTRAL_PLAYER_FACTION_SELECT_UI        = 0x25D7,
    SMSG_SHOW_QUEST_COMPLETION_TEXT                   = 0x2A95,
    SMSG_SHOW_TAXI_NODES                              = 0x26CF,//0x26CA,
    SMSG_SHOW_TRADE_SKILL_RESPONSE                    = 0x2776,//0x2770,
    SMSG_SOCKET_GEMS_FAILURE                          = 0x272A,//0x2724,
    SMSG_SOCKET_GEMS_SUCCESS                          = 0x2729,//0x2723,
    SMSG_SPECIAL_MOUNT_ANIM                           = 0x26A1,//0x269C,
    SMSG_SPEC_INVOLUNTARILY_CHANGED                   = 0x271A,//0x2714,
    SMSG_SPELL_ABSORB_LOG                             = 0x2C1C,//0x2C1F,
    SMSG_SPELL_CATEGORY_COOLDOWN                      = 0x2C16,//0x2C17
    SMSG_SPELL_CHANNEL_START                          = 0x2C31,//0x2C34
    SMSG_SPELL_CHANNEL_UPDATE                         = 0x2C32,//0x2C35
    SMSG_SPELL_COOLDOWN                               = 0x2C15,
    SMSG_SPELL_DAMAGE_SHIELD                          = 0x2C2E,//0x2C31
    SMSG_SPELL_DELAYED                                = 0x2C3C,//0x2C3F,
    SMSG_SPELL_DISPELL_LOG                            = 0x2C17,//0x2C1A
    SMSG_SPELL_ENERGIZE_LOG                           = 0x2C19,//0x2C1C,
    SMSG_SPELL_EXECUTE_LOG                            = 0x2C3D,//0x2C40,
    SMSG_SPELL_FAILED_OTHER                           = 0x2C52,//0x2C55,
    SMSG_SPELL_FAILURE                                = 0x2C50,//0x2C53,
    SMSG_SPELL_FAILURE_MESSAGE                        = 0x2C57,//0x2C5A,
    SMSG_SPELL_GO                                     = 0x2C36,//0x2C39,
    SMSG_SPELL_HEAL_ABSORB_LOG                        = 0x2C11,//0x2C1E,
    SMSG_SPELL_HEAL_LOG                               = 0x2C10,//0x2C1D,
    SMSG_SPELL_INSTAKILL_LOG                          = 0x2C30,//0x2C33
    SMSG_SPELL_INTERRUPT_LOG                          = 0x2C1D,//0x2C20,
    SMSG_SPELL_MISS_LOG                               = 0x2C3E,//0x2C41,
    SMSG_SPELL_NON_MELEE_DAMAGE_LOG                   = 0x2C2F,//0x2C32
    SMSG_SPELL_OR_DAMAGE_IMMUNE                       = 0x2C2C,//0x2C2F
    SMSG_SPELL_PERIODIC_AURA_LOG                      = 0x2C18,//0x2C1B,
    SMSG_SPELL_PREPARE                                = 0x2C35,//0x2C38,
    SMSG_SPELL_START                                  = 0x2C37,//0x2C3A,
    SMSG_SPELL_VISUAL_LOAD_SCREEN                     = 0x25CA,
    SMSG_SPIRIT_HEALER_CONFIRM                        = 0x2717,//0x2711,
    SMSG_SPLASH_SCREEN_SHOW_LATEST                    = 0x2875,
    SMSG_STAND_STATE_UPDATE                           = 0x271E,//0x2718,
    SMSG_START_ELAPSED_TIMER                          = 0x2601,
    SMSG_START_ELAPSED_TIMERS                         = 0x2608,//0x2603,
    SMSG_START_LIGHTNING_STORM                        = 0x26A9,//0x26A4
    SMSG_START_LOOT_ROLL                              = 0x261F,//0x261A,
    SMSG_START_MIRROR_TIMER                           = 0x2711,//0x270B,
    SMSG_START_TIMER                                  = 0x25A6,
    SMSG_STOP_ELAPSED_TIMER                           = 0x2602,
    SMSG_STOP_MIRROR_TIMER                            = 0x2713,//0x270D,
    SMSG_STOP_SPEAKERBOT_SOUND                        = 0x2772,//0x276C,
    SMSG_STREAMING_MOVIES                             = 0x25A5,
    SMSG_SUMMON_CANCEL                                = 0x26B2,//0x26AD,
    SMSG_SUMMON_RAID_MEMBER_VALIDATE_FAILED           = 0x2591,
    SMSG_SUMMON_REQUEST                               = 0x2723,//0x271D,
    SMSG_SUPERCEDED_SPELLS                            = 0x2C49,//0x2C4C,
    SMSG_SUSPEND_COMMS                                = 0x304A,
    SMSG_SUSPEND_TOKEN                                = 0x25AB,//0x25A8,
    SMSG_SYNC_WOW_ENTITLEMENTS                        = 0x2871,//0x286C,
    SMSG_TALENTS_INVOLUNTARILY_RESET                  = 0x2719,//0x2713,
    SMSG_TAXI_NODE_STATUS                             = 0x267E,//,//0x2679,
    SMSG_TEXT_EMOTE                                   = 0x267C,//0x2677,
    SMSG_THREAT_CLEAR                                 = 0x26DE,//0x26D9,
    SMSG_THREAT_REMOVE                                = 0x26DD,//0x26D8,
    SMSG_THREAT_UPDATE                                = 0x26DC,//0x26D7,
    SMSG_TIME_ADJUSTMENT                              = 0x2DD3,
    SMSG_TIME_SYNC_REQUEST                            = 0x2DD2,
    SMSG_TITLE_EARNED                                 = 0x26D9,//0x26D4,
    SMSG_TITLE_LOST                                   = 0x26D5,
    SMSG_TOTEM_CREATED                                = 0x26CA,//0x26C5,
    SMSG_TOTEM_MOVED                                  = 0x26CC,//0x26C7,
    SMSG_TRADE_STATUS                                 = 0x2582,
    SMSG_TRADE_UPDATED                                = 0x2581,
    SMSG_TRAINER_BUY_FAILED                           = 0x26E2,//0x26DD,
    SMSG_TRAINER_LIST                                 = 0x26E1,//0x26DC,
    SMSG_TRANSFER_ABORTED                             = 0x2705,//0x26FF,
    SMSG_TRANSFER_PENDING                             = 0x25CB,
    SMSG_TRANSMOGRIFY_NPC                             = 0x27F8,
    SMSG_TREASURE_PICKER_RESPONSE                     = 0x291F,
    SMSG_TRIGGER_CINEMATIC                            = 0x27D0,//0x27CA,
    SMSG_TRIGGER_MOVIE                                = 0x26CD,//0x26C8,
    SMSG_TURN_IN_PETITION_RESULT                      = 0x2750,//0x274A,
    SMSG_TUTORIAL_FLAGS                               = 0x27BD,
    SMSG_TWITTER_STATUS                               = 0x3043,
    SMSG_UI_HEALING_RANGE_MODIFIED                    = 0x2745,//0x2740,--
    SMSG_UI_ITEM_INTERACTION_NPC                      = 0x27FA,
    SMSG_UI_MAP_QUEST_LINES_RESPONSE                  = 0x2AA2,
    SMSG_UNDELETE_CHARACTER_RESPONSE                  = 0x27CD,
    SMSG_UNDELETE_COOLDOWN_STATUS_RESPONSE            = 0x27D4,//0x27CE,
    SMSG_UNLEARNED_SPELLS                             = 0x2C4B,//0x2C4E,
    SMSG_UNLOAD_CHILD_MAP                             = 0x257A,
    SMSG_UPDATE_AADC_STATUS_RESPONSE                  = 0x2888,
    SMSG_UPDATE_ACCOUNT_DATA                          = 0x270B,//0x2705,
    SMSG_UPDATE_ACTION_BUTTONS                        = 0x25DC,
    SMSG_UPDATE_BNET_SESSION_KEY                      = 0x282B,//0x2824,
    SMSG_UPDATE_CAPTURE_POINT                         = 0x2929,
    SMSG_UPDATE_CELESTIAL_BODY                        = 0x2820,
    SMSG_UPDATE_CHARACTER_FLAGS                       = 0x27C3,
    SMSG_UPDATE_CHARGE_CATEGORY_COOLDOWN              = 0x276C,
    SMSG_UPDATE_COOLDOWN                              = 0x276B,//0x2765,
    SMSG_UPDATE_EXPANSION_LEVEL                       = 0x2643,
    SMSG_UPDATE_GAME_TIME_STATE                       = 0x2827,
    SMSG_UPDATE_INSTANCE_OWNERSHIP                    = 0x26AB,//0x26A6,
    SMSG_UPDATE_LAST_INSTANCE                         = 0x268A,//0x2685,
    SMSG_UPDATE_OBJECT                                = 0x27D1,//0x27CB,
    SMSG_UPDATE_PRIMARY_SPEC                          = 0x25DA,//0x25D4,
    SMSG_UPDATE_TALENT_DATA                           = 0x25D9,//0x25D3,
    SMSG_UPDATE_TASK_PROGRESS                         = 0x278D,
    //SMSG_UPDATE_WEEKLY_SPELL_USAGE                    = 0x2C19,
    SMSG_UPDATE_WORLD_STATE                           = 0x2749,//0x2744,--
    SMSG_USERLIST_ADD                                 = 0x2BB9,
    SMSG_USERLIST_REMOVE                              = 0x2BBA,
    SMSG_USERLIST_UPDATE                              = 0x2BBB,
    SMSG_USE_EQUIPMENT_SET_RESULT                     = 0x2751,//0x274B,
    ...
    SMSG_VENDOR_INVENTORY                             = 0x25BA,//0x25B6,
    ...
    SMSG_WARDEN3_DISABLED                             = 0x2829,
    SMSG_WARDEN3_ENABLED                              = 0x2828,//0x2821,
    SMSG_WARFRONT_COMPLETE                            = 0x2760,//0x275A,
    SMSG_WARGAME_REQUEST_SUCCESSFULLY_SENT_TO_OPPONENT = 0x2935,
    SMSG_WEATHER                                      = 0x26A8,//0x26A3
    ...
    SMSG_WORLD_SERVER_INFO                            = 0x25B0,//0x25AD,
    SMSG_WOW_ENTITLEMENT_NOTIFICATION                 = 0x286D,
    SMSG_XP_GAIN_ABORTED                              = 0xBADD,//0x25C7,
    SMSG_XP_GAIN_ENABLED                              = 0x27AD,
    SMSG_ZONE_UNDER_ATTACK                            = 0x2BB5,

    // Opcodes that are not generated automatically
    SMSG_ACCOUNT_HEIRLOOM_UPDATE                      = 0x25B3,//0x25B0, // no client handler
    ...
    SMSG_QUERY_ITEM_TEXT_RESPONSE = 0x291E,
    SMSG_TREASURE_PICKER_RESPONSE = 0x291F,
    SMSG_ARENA_TEAM_QUERY_RESPONSE = 0x2920,
    SMSG_BATTLEFIELD_STATUS_NEED_CONFIRMATION = 0x2922,
    SMSG_BATTLEFIELD_STATUS_ACTIVE = 0x2923,
    SMSG_BATTLEFIELD_STATUS_QUEUED = 0x2924,
    SMSG_BATTLEFIELD_STATUS_NONE = 0x2925,
...
public:
    ...
    virtual void Call(WorldSession* session, WorldPacket& packet) const {};
